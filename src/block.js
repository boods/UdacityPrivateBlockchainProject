...
class Block {
     ...
     *  2. Save in an auxiliary variable the current hash of the block (`this` represent the block object)
    ...
    getBData() {
        ...
        try {
            let obj = JSON.parse(bodyAsJsonString);
            if ( obj.data === undefined )
            {
                return UNAVAILABLE_BLOCK;
            }

            if ( obj.data === 'Genesis Block')
            {
                return UNAVAILABLE_BLOCK;
            }
